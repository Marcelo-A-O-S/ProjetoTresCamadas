...
namespace WinFormsUI
{
    public partial class FrmGerenciarVendasParceladas : Form
    {
        ...
        private void CarregarInfoParcelas()
        {
            ...
            dGVInfoParcela.Columns[5].HeaderText = "Valor total da compra";
            dGVInfoParcela.Columns[5].DataPropertyName = "ValorTotal";
            dGVInfoParcela.Columns[5].Name = "ValorTotal";
            dGVInfoParcela.Columns[6].HeaderText = "Mês de realizacão da compra";
        ...
        private void CarregarRegistroVendaParcelda()
        {
            ...
            dGVRegistrosVendasParceladas.ColumnCount = 12;
        ...
        private void RecarregarGridVendasParceladas()
        {
            ...
            dGVRegistrosVendasParceladas.DataSource = gestaoVendas.ObterVendas().Result.Where(x => x.TipoDePagamento == "Venda Parcelada" && x.PagamentoRealizado == false).ToList();
        }
