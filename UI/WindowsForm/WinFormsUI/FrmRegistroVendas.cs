...
namespace WinFormsUI
{
    public partial class FrmRegistroVendas : Form
    {
        ...
        private void CarregarHeaderProdutos()
        {
            ...
            dGVProdutosVendas.Columns[6].Width = 250;
        ...
        private void CarregarRegistroVenda()
        {
            try
            {
                ...
                dGVRegistrosVendas.ColumnCount = 13;
                ...
                dGVRegistrosVendas.Columns[2].Width = 250;
                ...
                dGVRegistrosVendas.Columns[3].Width = 180;
                ...
                dGVRegistrosVendas.Columns[4].Width = 220;
                ...
                dGVRegistrosVendas.Columns[5].Width = 180;
                ...
                dGVRegistrosVendas.Columns[7].Width = 180;
                ...
                dGVRegistrosVendas.Columns[9].Width = 190;
                ...
                dGVRegistrosVendas.Columns[12].HeaderText = "Valor Pago";
                dGVRegistrosVendas.Columns[12].DataPropertyName = "ValorPago";
                dGVRegistrosVendas.Columns[12].Name = "ValorPago";
