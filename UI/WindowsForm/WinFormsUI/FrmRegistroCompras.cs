    ...
    public partial class FrmRegistroCompras : Form
    {
        ...
        private void CarregarDgvProdutos()
        {
            try
            {
                ...
                dGVProdutosCompras.Columns[1].Width = 150;
                ...
                dGVProdutosCompras.Columns[2].Width = 150;
                ...
                dGVProdutosCompras.Columns[3].Width = 150;
                ...
                dGVProdutosCompras.Columns[4].Width = 150;
                ...
                dGVProdutosCompras.Columns[10].Width = 150;
        ...
        private void CarregarDgvCompras()
        {
            try
            {
                ...
                dGVRegistrosCompras.Columns[2].Width = 150;
                ...
                dGVRegistrosCompras.Columns[3].Width = 150;
                ...
                dGVRegistrosCompras.Columns[4].Width = 150;
